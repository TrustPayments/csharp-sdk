...
namespace TrustPayments.Client
{
    /// <summary>
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            RestClient = new RestClient("https://ep.trustpayments.com:443/api");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://ep.trustpayments.com:443/api).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://ep.trustpayments.com:443/api")
        {
