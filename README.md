...
```
# Package Manager
Install-Package TrustPayments -Version 4.0.3
# .NET CLI
dotnet add package TrustPayments --version 4.0.3
# Paket CLI
paket add TrustPayments --version 4.0.3
# PackageReference
<PackageReference Include="TrustPayments" Version="4.0.3" />
```
