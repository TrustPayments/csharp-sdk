...
```
# Package Manager
Install-Package TrustPayments -Version 3.0.5
# .NET CLI
dotnet add package TrustPayments --version 3.0.5
# Paket CLI
paket add TrustPayments --version 3.0.5
# PackageReference
<PackageReference Include="TrustPayments" Version="3.0.5" />
```
