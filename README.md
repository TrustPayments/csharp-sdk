...
```
# Package Manager
Install-Package TrustPayments -Version 4.0.0
# .NET CLI
dotnet add package TrustPayments --version 4.0.0
# Paket CLI
paket add TrustPayments --version 4.0.0
# PackageReference
<PackageReference Include="TrustPayments" Version="4.0.0" />
```
