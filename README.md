...
```
# Package Manager
Install-Package TrustPayments -Version 2.2.0
# .NET CLI
dotnet add package TrustPayments --version 2.2.0
# Paket CLI
paket add TrustPayments --version 2.2.0
# PackageReference
<PackageReference Include="TrustPayments" Version="2.2.0" />
```
