...
```
# Package Manager
Install-Package TrustPayments -Version 4.0.2
# .NET CLI
dotnet add package TrustPayments --version 4.0.2
# Paket CLI
paket add TrustPayments --version 4.0.2
# PackageReference
<PackageReference Include="TrustPayments" Version="4.0.2" />
```
