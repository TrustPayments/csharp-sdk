...
```
# Package Manager
Install-Package TrustPayments -Version 3.0.8
# .NET CLI
dotnet add package TrustPayments --version 3.0.8
# Paket CLI
paket add TrustPayments --version 3.0.8
# PackageReference
<PackageReference Include="TrustPayments" Version="3.0.8" />
```
