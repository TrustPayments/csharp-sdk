...
```
# Package Manager
Install-Package TrustPayments -Version 5.0.0
# .NET CLI
dotnet add package TrustPayments --version 5.0.0
# Paket CLI
paket add TrustPayments --version 5.0.0
# PackageReference
<PackageReference Include="TrustPayments" Version="5.0.0" />
```
