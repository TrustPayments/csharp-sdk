...
```
# Package Manager
Install-Package TrustPayments -Version 3.0.4
# .NET CLI
dotnet add package TrustPayments --version 3.0.4
# Paket CLI
paket add TrustPayments --version 3.0.4
# PackageReference
<PackageReference Include="TrustPayments" Version="3.0.4" />
```
